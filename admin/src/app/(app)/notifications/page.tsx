          ...
          <CardContent className="space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-muted-foreground">{audienceMeta.helper}</p>
              </div>
              {scope !== 'broadcast' && (
            ...
            <Button
              ...
              size="sm"
            >
              <Send className="h-3.5 w-3.5" /> {mu.isPending ? 'Sending…' : 'Send notification'}
            </Button>
          </CardContent>
        </Card>
            ...
            <div className="rounded-md border border-border bg-card p-3 shadow-card">
              <div className="flex items-start gap-2.5">
                ...
                <div className="min-w-0 flex-1">
                  <div className="text-[10.5px] uppercase tracking-wide text-muted-foreground">Saxony Smart Campus</div>
                  <div className={cn('mt-0.5 truncate text-[12.5px] font-medium', !title && 'text-muted-foreground')}>
                    {title || 'Notification title'}
                  </div>
                  <div className={cn('mt-0.5 line-clamp-3 whitespace-pre-line text-[12px]', !body && 'text-muted-foreground')}>
